    ...
    foreach ($musica as $mus): ?>
        <div class="activity-item">
            <div class="activity-content">
                ...
                <button onclick="if(confirm('Tem certeza que deseja excluir?')){window.location.href='../../components/musica/deleteMusica.php?id=<?= $mus['id'] ?>';}" type="button" class="btn-global btn-danger"><i class="fas fa-trash-alt"></i></button>
            </div>
        </div>
    <?php endforeach;
