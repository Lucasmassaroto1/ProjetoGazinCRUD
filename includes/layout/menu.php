...
if(in_array($paginaAtual, ['dashboard', 'comandos', 'estatistica', 'configuracoes', 'perfil'])){
    $itens_menu[] = ['href' => $base_url . 'admin/pages/painel/comandos.php', 'icon' => 'fas fa-terminal', 'label' => 'Comandos', 'active' => ($paginaAtual == 'comandos')];
    $itens_menu[] = ['href' => $base_url . 'admin/pages/painel/estatisticas.php', 'icon' => 'fas fa-chart-bar', 'label' => 'Estatísticas', 'active' => ($paginaAtual == 'estatistica')];
    $itens_menu[] = ['href' => $base_url . 'admin/pages/painel/configuracoes.php', 'icon' => 'fas fa-cog', 'label' => 'Configurações', 'active' => ($paginaAtual == 'configuracoes')];
    $itens_menu[] = ['href' => $base_url . 'admin/pages/painel/perfil.php', 'icon' => 'fas fa-user', 'label' => 'Perfil', 'active' => ($paginaAtual == 'perfil')];
    ...
    <button class="toggle">
        ...
        <nav class="menu-lateral">
            ...
            <ul>
                ...
                <li><a href="<?=$base_url?>admin/pages/painel/dashboard.php" class="<?= ($paginaAtual == 'dashboard') ? 'link-ativo' : '' ?>"><i class="fas fa-table-columns"></i> Dashboard</a></li>
